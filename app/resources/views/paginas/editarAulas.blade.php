<x-layout titulo="Editar Aula - Senac">
    <div class="container-xl py-4 shadow">
        ...
        <ul class="nav nav-pills gap-2 mb-4">
            ...
            <li class="nav-item">
                <a class="btn btn-primary active" href="/aulas"><i class="bi bi-person"></i> Alunos</a>
            </li>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <select name="status" class="form-select" required>
                        ...
                        <option value="pendente" {{ strtolower($dado->status) == 'pendente' ? 'selected' : '' }}>Pendente</option>
                        <option value="andamento" {{ strtolower($dado->status) == 'andamento' ? 'selected' : '' }}>Em andamento</option>
                    </select>
                </div>
            </div>
